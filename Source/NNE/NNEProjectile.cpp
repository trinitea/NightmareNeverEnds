...
ANNEProjectile::ANNEProjectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &ANNEProjectile::OnHit);		// set up a notification for when this component hits something
