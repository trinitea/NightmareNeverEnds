...
ASquash::ASquash(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void ASquash::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void ASquash::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void ASquash::MoveForward(float Value)
{
	ServerMoveForward(Value);
}

void ASquash::ServerMoveForward_Implementation(float Value)
{
	MulticastMoveForward(Value);
}

bool ASquash::ServerMoveForward_Validate(float Value)
{
	return true;
}

void ASquash::MulticastMoveForward_Implementation(float Value)
{
...
void ASquash::MoveRight(float Value)
{
	ServerMoveRight(Value);
}

void ASquash::ServerMoveRight_Implementation(float Value)
{
	MulticastMoveRight(Value);
}

bool ASquash::ServerMoveRight_Validate(float Value)
{
	return true;
}

void ASquash::MulticastMoveRight_Implementation(float Value)
{
	if ((Controller != NULL) && (Value != 0.0f))
	{
		if (mode == ControlMode::Default)
...
void ASquash::Stretch(UAnchor* controlledAnchor, UAnchor* grabbingAnchor)
{
	ServerStretch(controlledAnchor, grabbingAnchor);
}

void ASquash::ServerStretch_Implementation(UAnchor* controlledAnchor, UAnchor* grabbingAnchor)
{
	MulticastStretch(controlledAnchor, grabbingAnchor);
}

bool ASquash::ServerStretch_Validate(UAnchor* controlledAnchor, UAnchor* grabbingAnchor)
{
	return true;
}

void ASquash::MulticastStretch_Implementation(UAnchor* controlledAnchor, UAnchor* grabbingAnchor)
{
...
void ASquash::VStretch(float Value)
{
	ServerVStretch(Value);
}

void ASquash::ServerVStretch_Implementation(float Value)
{
	MulticastVStretch(Value);
}

bool ASquash::ServerVStretch_Validate(float Value)
{
	return true;
}

void ASquash::MulticastVStretch_Implementation(float Value)
{
...
void ASquash::ElasticPhysics(FVector handsPos, FVector feetPos)
{
	FVector midPoint = FMath::Lerp(handsPos, feetPos, 0.5f);
...
void ASquash::CalculateTension(FVector aPos, FVector bPos)
{
...
void ASquash::HoldHands()
{
	ServerHoldHands();
}

void ASquash::ServerHoldHands_Implementation()
{
	MulticastHoldHands();
}

bool ASquash::ServerHoldHands_Validate()
{
	return true;
}

void ASquash::MulticastHoldHands_Implementation()
{
	hands->keyPressed = true;
}

void ASquash::HoldFeet()
{
	ServerHoldFeet();
}

void ASquash::ServerHoldFeet_Implementation()
{
	MulticastHoldFeet();
}


bool ASquash::ServerHoldFeet_Validate()
{
	return true;
}

void ASquash::MulticastHoldFeet_Implementation()
{
	feet->keyPressed = true;
}


void ASquash::ReleaseHands()
{
	ServerReleaseHands();
}

void ASquash::ServerReleaseHands_Implementation()
{
	MulticastReleaseHands();
}

bool ASquash::ServerReleaseHands_Validate()
{
	return true;
}

void ASquash::MulticastReleaseHands_Implementation()
{
	hands->keyPressed = false;
}

void ASquash::ReleaseFeet()
{
	ServerReleaseFeet();
}

void ASquash::ServerReleaseFeet_Implementation()
{
	MulticastReleaseFeet();
}

bool ASquash::ServerReleaseFeet_Validate()
{
	return true;
}

void ASquash::MulticastReleaseFeet_Implementation()
{
	feet->keyPressed = false;
}

void ASquash::SetControlMode(ControlMode mode)
{
