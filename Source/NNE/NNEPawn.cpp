...
void ANNEPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
...
void ANNEPawn::Tick(float DeltaSeconds)
{
...
void ANNEPawn::FireShot(FVector FireDirection)
{
...
void ANNEPawn::ShotTimerExpired()
{
	bCanFire = true;
}
